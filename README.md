...
<table border="0" style="border-collapse: collapse; border: none; width: 100%; background-color: #ffffff;">

  <tr style="border: none; background-color: #ffffff;">
    <td align="left" width="15%" style="border: none; vertical-align: middle; padding: 12px 0; background-color: #ffffff;">
    ...
    <td align="left" width="85%" style="border: none; vertical-align: middle; padding: 12px 15px; background-color: #ffffff;">
      <b style="color: #24292f;">Core Development & Logic</b><br/>
      <font size="2" color="#57606a">Asynchronous reactive programming engineered with Kotlin Coroutines, Kotlin Flow, and clean thread scheduling.</font>
    </td>
  </tr>
  ...
  <tr style="border: none; background-color: #ffffff;">
    ...
    <td align="left" width="85%" style="border: none; vertical-align: middle; padding: 12px 15px; background-color: #ffffff;">
      <b style="color: #24292f;">IDE & Build Automation</b><br/>
      <font size="2" color="#57606a">Native development in Android Studio, multi-variant compilation management, and optimized Gradle build scripting.</font>
    </td>
  </tr>
  ...
  <tr style="border: none; background-color: #ffffff;">
    ...
    <td align="left" width="85%" style="border: none; vertical-align: middle; padding: 12px 15px; background-color: #ffffff;">
      <b style="color: #24292f;">Cloud Infrastructure & DevOps</b><br/>
      <font size="2" color="#57606a">Real-time data caching, Firestore cloud synchronization pipelines, and structured Git workflow architectures.</font>
    </td>
  </tr>
  ...
  <tr style="border: none; background-color: #ffffff;">
    ...
    <td align="left" width="85%" style="border: none; vertical-align: middle; padding: 12px 15px; background-color: #ffffff;">
      <b style="color: #24292f;">Material Design & UI Canvas</b><br/>
      <font size="2" color="#57606a">Translating Figma designs into pixel-perfect, declarative layouts using modern Jetpack Compose and Material 3.</font>
    </td>
  </tr>
